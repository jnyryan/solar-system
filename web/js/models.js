var Planets = (function() {
  ...
  Planets.prototype.drawTheSun = function() {
    return drawPlanet("Sun", 2, {
      x: 0,
      y: 0,
      z: 0
    });
  };
  Planets.prototype.drawMercury = function() {
    return drawPlanet("Mercury", 0.3, {
      x: 2.5,
      y: 1,
      z: 0
    });
  }
  Planets.prototype.drawVenus = function() {
    return drawPlanet("Venus", 0.7, {
      x: -5.5,
      y: 0,
      z: 0
    });
  }
  Planets.prototype.drawTheEarth = function() {
    return drawPlanet("Earth", 1, {
      x: -7.5,
      y: -2.25,
      z: 0
    });
  }
  Planets.prototype.drawTheMoon = function() {
    return drawPlanet("Moon", 0.2, {
      x: -9.5,
      y: -2,
      z: 0
    });
  }
  Planets.prototype.drawTheMars = function() {
    return drawPlanet("Mars", 0.8, {
      x: 14,
      y: 4,
      z: -10
    });
